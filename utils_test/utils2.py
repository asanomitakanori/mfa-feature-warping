...
#     gx_temp = gx.copy()
#     gy_temp = gy.copy()
#     dist_matrix = np.zeros((1920, 1080))
#     for localization in range(1, 25):
#         cnt = 0
#         precision = []
#         recall = []
...
#                 curgx = int(gx[jj])
#                 curgy = int(gy[jj])
#                 bbox_whole_dt = dist_matrix.copy()
#                 if (curx -10 >= 0) and (cury -10 >= 0):
#                     bbox_whole_dt[0:curx, 0:cury] += 1
#                 elif curx -10 < 0:
#                     bbox_whole_dt[0:curx, cury-10:cury] += 1
#                 elif cury -10 < 0:
#                     bbox_whole_dt[curx-10:curx, 0:cury] += 1
#                 else:
#                     bbox_whole_dt[(curx-10):curx, (cury-10):cury] += 1

#                 bbox_whole_gt = dist_matrix.copy()
#                 if (curgx -10 >= 0) and (curgy -10 >= 0):
#                     bbox_whole_gt[0:curgx, 0:curgy] += 1
#                 elif curgx -10 < 0:
#                     bbox_whole_gt[0:curgx, curgy-10:curgy] += 1
#                 elif curgy -10 < 0:
#                     bbox_whole_gt[curgx-10:curgx, 0:curgy] += 1
#                 else:
#                     bbox_whole_gt[curgx-10:curgx, curgy-10:curgy] += 1
#                 dist = np.sum(bbox_whole_dt * bbox_whole_gt)
#                 # dist = np.sqrt((curx - curgx) ** 2 + (cury - curgy) ** 2)
...
#             if ii >= 1:
#                 if recall[ii-1] == cnt / len(gx_temp):
#                     precision.append(cnt / (ii+1))
#                     recall.append(cnt / len(gx_temp))             
#                 else:
#                     precision.append(cnt / (ii+1))
#                     recall.append(cnt / len(gx_temp))
#                     AP.append((recall[ii] - recall[ii-1])*(precision[ii]+precision[ii-1])*0.5)
